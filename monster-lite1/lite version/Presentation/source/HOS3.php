...
img{
	...
	<body style="background-color:#white !important">
                ...
                $sth = $dbh->query("select DISTINCT H.CIN, H.medecinID , P.Nom as nom_patient ,M.nom as medecin_nom,M.serviceID as service,H.created 
              ...
              <a href='ajouth.html' class='btn pull-right hidden-sm-down btn-success' style='float:right;'>Ajout d'hospitalisation</a>
          </div>
            ...
            while($row = $sth->fetch(PDO::FETCH_ASSOC)){  //Creates a loop to loop through results
              echo "<tr><td > " . $row['CIN'] . "</td><td >" . $row['medecinID'] ."</td><td >" . $row['nom_patient'] ."</td><td >" . $row['medecin_nom'] ."</td><td >" . $row['service'] ."</td><td >" . $row['created'] ."</td></tr>"; //$row['index'] the index here is a field name
              }
